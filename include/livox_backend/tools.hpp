...
#define PLV(a) vector<Eigen::Matrix<double, a, 1>, Eigen::aligned_allocator<Eigen::Matrix<double, a, 1>>>//等于Vector<Eigen::Matrix<double, a, 1>>,因为是eigen，所以需要使用内存分配器
